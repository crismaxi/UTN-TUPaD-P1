...
opcion = int(input ("Ingrese la opcion 1 para transformar el nombre en MAYUSCULAS , Ingrese la opcion 2 para transformar el nombre en MINUSCULAS: , Ingrese la opcion 3 para transformar la primera letra en MAYUSCULA: "))
...
if opcion == 1:
    ...
    print("Ingrese la opcion 1, 2 o 3")
